...
# def get_reader():
#     """
#     Thread-safe lazy loader for EasyOCR reader.
#     Each thread initializes its own reader once,
#     avoiding reloading and preventing race conditions.
#     """
#     if not hasattr(_thread_local, "reader"):
#         print("Initializing OCR reader (per thread)...", flush=True)
#         try:
#             _thread_local.reader = easyocr.Reader(['ch_sim', 'en'], gpu=False)
#             print("OCR reader loaded successfully", flush=True)
#         except Exception as e:
#             print(f"Error loading OCR: {e}", flush=True)
#             raise
